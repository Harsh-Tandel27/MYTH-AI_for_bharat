...
import { Zap, Users, Globe, Mail, Lock, User, ArrowRight, Github } from 'lucide-react';
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-400 text-sm">
                Start building amazing websites with AI-powered development
              </p>
            </div>
            ...
            <div className="bg-gray-950/50 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Build websites in minutes, not weeks</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-950/50 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Collaborate seamlessly with your team</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-950/50 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Deploy anywhere with one click</p>
                </div>
              </div>
            </div>
          </motion.div>
